...
<div class="d-flex " id="wrapper">
    ...
    <div class="border-end bg-dark sidebar sidebar-heading" id="sidebar-wrapper">
        ...
        <div class=" list-group-flush side-nav">
            ...
            <a class="list-group-item list-group-item-action list-group-item-light p-3 bg-dark border-bottom border-white navigation sidebar-heading" href="{{route('expenses')}}"><span class="sideheading">Expenses & Payments</span></a>
